...
public class DMConnection extends Connection<DMDatabase> {
    protected DMConnection(DMDatabase database, java.sql.Connection connection) {
    ...
    protected void doChangeCurrentSchemaOrSearchPathTo(String schemaNameOrSearchPath) throws SQLException {
        this.jdbcTemplate.execute("ALTER SESSION SET CURRENT_SCHEMA=" + this.database.quote(schemaNameOrSearchPath));
    }
